...
describe('action.js', () => {
  ...
  it('objectToCsVが機能するかテスト', () => {
    ...
    const result = `src,subj,tool_type,period,year,content_type,author,image_index,included_pages_num,fix_text\n` + `scanned/20180802_2年3紐。5組『倫理社会」前期定期試験1.jpg,倫理社会,テスト,前期定期,2018,,,,,\n` + `scanned/20180802_2年3紐。5組『倫理社会」前期定期試験2.jpg,,,,,,,,,`
  ...
  it('setCommitCSV', async () => {
    ...
    fetchMock.get(
      ...
      body:{
          ...
          "url": "https://api.github.com/repos/satackey/test-preps/git/refs/heads/cmstest",
          "object": {
            "sha": "58c821fea857ca1e270c3b34f5bc97db64c84fc9",
            "type": "commit",
            "url": "https://api.github.com/repos/satackey/test-preps/git/commits/58c821fea857ca1e270c3b34f5bc97db64c84fc9"
          }
        }
      }
    )
    ...
    fetchMock.get(
      `http://localhost:8085/.netlify/git/github/commits/${commitsHash}`, {
        ...
        body: {
          "sha": "58c821fea857ca1e270c3b34f5bc97db64c84fc9",
          "node_id": "MDY6Q29tbWl0MTk3ODY2NDY0OjU4YzgyMWZlYTg1N2NhMWUyNzBjM2IzNGY1YmM5N2RiNjRjODRmYzk=",
          "commit": {
            "author": {
              "name": "test",
            ...
            "tree": {
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/2192c7b798b4d4479e942f4d065780b44a04dbd6"
            },
            "url": "https://api.github.com/repos/satackey/test-preps/git/commits/58c821fea857ca1e270c3b34f5bc97db64c84fc9",
            "comment_count": 0,
            "verification": {
          ...
          "url": "https://api.github.com/repos/satackey/test-preps/commits/58c821fea857ca1e270c3b34f5bc97db64c84fc9",
          "html_url": "https://github.com/satackey/test-preps/commit/58c821fea857ca1e270c3b34f5bc97db64c84fc9",
          "comments_url": "https://api.github.com/repos/satackey/test-preps/commits/58c821fea857ca1e270c3b34f5bc97db64c84fc9/comments",
          "author": {
            "login": "hogehogefuga",
            "id": 8703329,
            ...
            "followers_url": "https://api.github.com/users/hogehogefuga/followers",
            "following_url": "https://api.github.com/users/hogehogefuga/following{/other_user}",
            "gists_url": "https://api.github.com/users/hogehogefuga/gists{/gist_id}",
            "starred_url": "https://api.github.com/users/hogehogefuga/starred{/owner}{/repo}",
            "subscriptions_url": "https://api.github.com/users/hogehogefuga/subscriptions",
            "organizations_url": "https://api.github.com/users/hogehogefuga/orgs",
            "repos_url": "https://api.github.com/users/hogehogefuga/repos",
            "events_url": "https://api.github.com/users/hogehogefuga/events{/privacy}",
            "received_events_url": "https://api.github.com/users/hogehogefuga/received_events",
            "type": "User",
            "site_admin": false
          },
          "committer": {
          ...
          "parents": [
            {
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/commits/184dc414ac5f556bc32e9fc07dc0ee40aff71152",
              "html_url": "https://github.com/satackey/test-preps/commit/184dc414ac5f556bc32e9fc07dc0ee40aff71152"
            }
          ],
          "stats": {
            "total": 0,
    ...
    fetchMock.post(
      `http://localhost:8085/.netlify/git/github/git/blobs?ref=${branchName}`, {
        ...
        body: {
          ...
          "url": "https://api.github.com/repos/satackey/test-preps/git/blobs/8c187d7baccab1c2abf487e09051f0ee8cb04c18"
        }
      }
    )
          ...
          "tree": [
            {
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/e78a725a4d3309a27794e0492b48da41c572035c"
            },
            {
              "path": ".github",
              "mode": "040000",
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/e45de82cfd0a76a71b32fbdc890145d46a223fe3"
            },
            {
              "path": ".gitignore",
              "mode": "100644",
              ...
              "size": 622,
              "url": "https://api.github.com/repos/satackey/test-preps/git/blobs/371774330ed12a8140bbbe77bcb278cbdc0fb17a"
            },
            {
              "path": ".vscode",
              "mode": "040000",
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/4e1084651b521e37c32f9d15a43657fe4de68702"
            },
            {
              "path": "README.md",
              "mode": "100644",
              ...
              "size": 11,
              "url": "https://api.github.com/repos/satackey/test-preps/git/blobs/cdda0cf26096005c0307a1fc25e3ad8c9a90d9b4"
            },
            {
              "path": "metadatas",
              "mode": "040000",
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/b01117334bf8d1d98e623abd1bb955875851814c"
            },
            {
              "path": "scanned",
              "mode": "040000",
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/991f22994b75373529dbe374a61617ad9ea55404"
            },
            {
              "path": "studies",
              "mode": "040000",
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/bfa78578cfff5aaed51123f3d7d1c35153ff72a5"
            },
            {
              "path": "test.csv",
              "mode": "100644",
            ...
            },
            {
              ...
              "url": "https://api.github.com/repos/satackey/test-preps/git/trees/cc611fe7719cd4fc2ebfbb8adef3f20daf2eea7b"
            }
          ],
          "truncated": false
        }
    ...
    fetchMock.post(
      `http://localhost:8085/.netlify/git/github/git/commits?ref=${branchName}`, {
        ...
        body: {
          ...
          "node_id": "MDY6Q29tbWl0MTk3ODY2NDY0OjFjZTBkNmVjMDJmZjRhMzY0MjQ1YTRmNDM1Y2RmOWE3MTE5NTA3YTQ=",
          "url": "https://api.github.com/repos/satackey/test-preps/git/commits/1ce0d6ec02ff4a364245a4f435cdf9a7119507a4",
          "html_url": "https://github.com/satackey/test-preps/commit/1ce0d6ec02ff4a364245a4f435cdf9a7119507a4",
          "author": {
            "name": "test",
            "email": "hoge@gmail.com",
